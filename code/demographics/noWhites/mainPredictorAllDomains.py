...
# Michele Albach
# This file performs 1000 50/50 train test splits on all data from the main survey, but using data without any caucasian survey respondents
...
def load(props):
    file = open("../modifiedData/MainBailNoWhites.csv",'r')
    recdata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/MainUnemNoWhites.csv",'r')
    unemdata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/MainCPSNoWhites.csv",'r')
    cpsdata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/MainHosNoWhites.csv",'r')
    hosdata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/MainLoanNoWhites.csv",'r')
    loandata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/MainInsNoWhites.csv",'r')
