...
# Michele Albach
# This file performs one test by training on the data from five domain and testing on the remaining one (from the second survey) with interaction variables
