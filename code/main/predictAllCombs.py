...
accsfile = open("../../results/MainCombsAccuraciesAndWeights.csv",'w')
write = csv.writer(accsfile)
write.writerows(rows)
accsfile.close()
accsfile = open("../../results/MainAllCombsWOAccuraciesAndWeights.csv",'w')
write = csv.writer(accsfile)
