...
# Michele Albach
# This file calls for all tests using data without caucasians respondents from the survey that removed relevance entirely
...
accsfile = open("RemovedAccuraciesAndWeightsNoWhites.csv",'w')
