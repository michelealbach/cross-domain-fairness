...
#    file = open("../data/NoRelevanceIns.csv",'r')
    ...
    for i in range(len(traindata)):
        for k in range(int((len(traindata[0])-15)/f)):
            try:
...
def CrossDomain1v5Interaction(train_domain,props):
    # 'train_domain' should be 'rec', 'unem', 'cps', 'hos', 'loan', or 'ins'
...
#print(CrossDomain1v5Interaction("Bail",[0,1,2,3,4,5,'S',7]))
#print(CrossDomain1v5Interaction("Bail",[0,1,2,3,4,5,'S']))
