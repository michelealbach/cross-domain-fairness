...
# Michele Albach
# This file performs 1000 50/50 train test splits on the data without male respondents from a particular domain from the survey that removed relevance entirely, 
...
def load(domain,props):
    file = open("../modifiedData/Removed"+domain+"NoMales.csv",'r')
