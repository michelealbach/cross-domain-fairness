...
# Michele Albach
# This file calls for all tests using data without male respondents from the survey that replaced relevance with increases accuracy
...
accsfile = open("ReplacedAccuraciesAndWeightsNoMales.csv",'w')
