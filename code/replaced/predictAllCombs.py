...
accsfile = open("../../results/ReplacedCombsAccuraciesAndWeights.csv",'w')
write = csv.writer(accsfile)
write.writerows(rows)
accsfile.close()
accsfile = open("../../results/ReplacedAllCombsWOAccuraciesAndWeights.csv",'w')
write = csv.writer(accsfile)
