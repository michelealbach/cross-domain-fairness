...
# Michele Albach
# This file performs 1000 50/50 train test splits using data without male survey respondents from a particular domain from the survey that replaced relevance with increases accuracy
...
def load(domain,props):
    file = open("../modifiedData/Replaced"+domain+"NoMales.csv",'r')
