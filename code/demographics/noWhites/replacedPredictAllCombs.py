...
accsfile = open("ReplacedCombsAccuraciesAndWeightsNoWhites.csv",'w')
write = csv.writer(accsfile)
write.writerows(rows)
accsfile.close()
accsfile = open("ReplacedAllCombsWOAccuraciesAndWeightsNoWhites.csv",'w')
write = csv.writer(accsfile)
