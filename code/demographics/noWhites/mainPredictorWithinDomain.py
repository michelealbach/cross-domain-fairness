...
# Michele Albach
# This file performs 1000 50/50 train test splits on the data from a particular domain from the main survey, but using data without any caucasian respondents
...
def load(domain,props):
    file = open("../modifiedData/Main"+domain+"NoWhites.csv",'r')
