...
rows2 = [["Prediction","Accuracy","Error","Reliability","Relevance","Privacy","Volitionality","Causes Outcome","Causes Cycle","Causes Disparity","Caused by Group"]]
...
accsfile = open("MainCombsAccuraciesAndWeightsNoWhites.csv",'w')
write = csv.writer(accsfile)
write.writerows(rows)
accsfile.close()
accsfile = open("MainAllCombsWOAccuraciesAndWeightsNoWhites.csv",'w')
write = csv.writer(accsfile)
