...
# Michele Albach
# This file makes a version of Figure 1 but using data without caucasian respondents
...
file = open("MainAccuraciesAndWeightsNoWhites.csv")
secdata = list(csv.reader(file))
file.close()
file = open("ReplacedAccuraciesAndWeightsNoWhites.csv")
accdata = list(csv.reader(file))
file.close()
file = open("RemovedAccuraciesAndWeightsNoWhites.csv")
...
plt.savefig("Figure1NoWhites.pdf")
