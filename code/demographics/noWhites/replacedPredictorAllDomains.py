...
# Michele Albach
# This file performs 1000 50/50 train test splits using data without caucasian survey respondents from the survey that replaced relevance with increases accuracy
...
def load(props):
    file = open("../modifiedData/ReplacedBailNoWhites.csv",'r')
    recdata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/ReplacedUnemNoWhites.csv",'r')
    unemdata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/ReplacedCPSNoWhites.csv",'r')
    cpsdata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/ReplacedHosNoWhites.csv",'r')
    hosdata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/ReplacedLoanNoWhites.csv",'r')
    loandata = list(csv.reader(file))
    file.close()
    file = open("../modifiedData/ReplacedInsNoWhites.csv",'r')
...
#print(AllDomains([0,1,2,3,4,5,6,7]))
