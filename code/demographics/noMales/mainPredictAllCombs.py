...
accsfile = open("MainCombsAccuraciesAndWeightsNoMales.csv",'w')
write = csv.writer(accsfile)
write.writerows(rows)
accsfile.close()
accsfile = open("MainAllCombsWOAccuraciesAndWeightsNoMales.csv",'w')
write = csv.writer(accsfile)
