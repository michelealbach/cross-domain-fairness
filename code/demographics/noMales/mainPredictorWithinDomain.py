...
# Michele Albach
# This file performs 1000 50/50 train test splits on the data from a particular domain from the main survey, but using data without any male respondents
...
def load(domain,props):
    file = open("../modifiedData/Main"+domain+"NoMales.csv",'r')
