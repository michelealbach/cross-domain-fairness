...
# Michele Albach
# This file performs 1000 50/50 train test splits on all data from our 'removed' survey that removed relevance as a property
...
def AllDomains(props):
    # 'props' should be a list of the integers (0..6) with any property that should be skipped as an 'S' instead
    [X,Y] = load(props)
    accs = []
...
# Property order for which to skip is [Reliability,Privacy,Volitionality,Causes Outcome,Causes Cycle,Causes Disparity,Caused By Group]
#print(AllDomains([0,1,'S',3,4,5,6]))
